...
public:
    ...
    */
    ...
    Character   _character[1<<16]; //65536
    FT_Library  _library;//字体库
    FT_Face     _face; //对应的是黑体 宋体 之类的对象 
    char*       _fontBuffer;
    //! 字体文理的宽度
    int             _textureWidth;
    //! 字体文理的高度
    ...
    void    buildSystemFont(const char* font,int fontSize)
    {
        ...
        */
        ...
        glTexImage2D( 
            ...
            GL_ALPHA,           //! 纹理的使用的存储格式 注意这个优化  只有alpha  则只有一个字节  如果rgba  则4个
            _textureWidth,
            _textureHeight,
            0,                  //! 是否的边
        ...
        FT_Select_Charmap( ftFace, FT_ENCODING_UNICODE );  //unicode 还是 多字符集
